                                                       ...
                                                       <thead>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                         ...
                                                         while($row = $result->fetch_assoc()) {
                                                           ...
                                                           <td><?php echo $row["situationFam"] ?></td>

                <td><a href="../views/supprimerClient.php?<?php echo 'CIN=' . $row["CIN"]   ?>">supprimer</a></td>

                <td><a href="../views/page-update.php?<?php echo 'CIN=' . $row["CIN"]   ?>">modifier</a></td>
											...
											<div class="row my_setting_content_details">
												<div class="col-xl-4">
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="text" class="form-control" id="formGroupExampleInputY" placeholder="UX/UI, HTML, Photoshop">
													</div>
												</div>
												<div class="col-xl-4">
