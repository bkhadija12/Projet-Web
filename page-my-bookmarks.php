...
<!-- Mirrored from grandetest.com/theme/edumy-html/page-my-bookmarks.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Nov 2019 14:50:53 GMT -->
<head>
<meta charset="utf-8">
						...
						<div class="dropdown">
						    ...
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
							    	...
							    	<p>Kim Hunter <br><span class="address"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="650e0c080d100b110017250208040c094b060a08">[email&#160;protected]</a></span></p>
						    	</div>
                ...
                <li class="user_setting">
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	<div class="user_set_header">
					    		<img class="float-left" src="images/team/e1.png" alt="e1.png">
						    	<p>Kim Hunter <br><span class="address"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="28434145405d465c4d5a684f45494144064b4745">[email&#160;protected]</a></span></p>
					    	</div>
					    	<div class="user_setting_content">
								<a class="dropdown-item active" href="#">My Profile</a>
								<a class="dropdown-item" href="#">Messages</a>
			...
			<div class="user_board">
				...
				<div class="dashbord_nav_list">
					<ul>
						...
						<li class="active"><a href="page-my-bookmarks.html"><span class="flaticon-like"></span> Bookmarks</a></li>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
										<h4 class="title float-left">Bookmarks</h4>
														...
														<ul class="mb0">
															<li class="list-inline-item">
																<select class="selectpicker show-tick">
																	<option>Nouveaux produits</option>
																	<option>Recent</option>
																	<option>anciens produits</option>
																</select>
															</li>
															<li class="list-inline-item">
...
{
    echo ' <div class="my_course_content_list">
											...
											<div class="thumb">
												...
												<div class="mc_footer">
													<ul class="mc_meta fn-414">
												       ...
												       -Id produit: <li class="list-inline-item"><a href="#">'.$row["IDProduit"].'</a></li><br>

														-Nom: <li class="list-inline-item"><a href="#">'.$row["nom"].'</a></li><br>
													
														Nombre:<li class="list-inline-item">'.$row["nbProduit"].'</li><br>
													</ul>
													<ul class="mc_review fn-414">
														
														-prix: <li class="list-inline-item tc_price fn-414"><a href="#">'.$row["prix"].'</a></li><br>
														<li class="list-inline-item tc_price fn-414"><a href="#">'.$row["descrition"].'</a></li>
													</ul>
													<ul class="view_edit_delete_list float-right">
											    				...
											    				<li class="list-inline-item">
<form action="modifierr.php" method="get">
                    ...
                    <input class="ab" type="submit" name="modifier" value="modifier">
											    				...
											    				<form method="POST" action="supprimerproduit.php">
                                                                 <input class="ab" type="submit" name="supprimer" value="supprimer">
