...
$listcategorie = $categorie->affichercategorie();
...
?>
													...
													<form method="post" name="myform" action=ajoutProduit.php>
															<div class="my_profile_setting_input form-group">
														    	...
														    	<input type="text" class="form-control" id="formGroupExampleInput1" name="idproduit" placeholder="12547">
															</div>
															<div class="my_profile_setting_input form-group">
														...
														<div class="col-xl-6">
															<div class="my_profile_setting_input form-group">
														    	...
														    	<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="5 dt" name="prix">
															</div>
															<div class="my_profile_setting_input form-group">
														    	<label for="exampleInputPhone">Quantité du produit</label>
														    	<input type="text" class="form-control" id="exampleInputPhone" name="nb">
															</div>

															<div class="my_profile_setting_input form-group">
														    	<label for="exampleInputPhone">Description du produit</label>
														    	<input type="text" class="form-control" id="exampleInputPhone" name="description">
															</div>
															<div class="my_profile_setting_input form-group">
														    	<label for="exampleInputPhone">categorie du produit</label>
														    	<select><?php foreach ($listcategorie as $row)
{?>
...
?>
														...
														<div class="col-lg-12">
															...
															<input type="file" name="image" value="upload" name="image">
														</div>

														<input type="submit" name="ajouter" value="ajouter produit" onclick="test()">
