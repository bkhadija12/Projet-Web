...
<!-- Mirrored from grandetest.com/theme/edumy-html/page-my-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Nov 2019 14:50:53 GMT -->
<head>
<meta charset="utf-8">
						...
						<div class="dropdown">
						    ...
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
							    	...
							    	<p>Kim Hunter <br><span class="address"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e68d8f8b8e9388928394a6818b878f8ac885898b">[email&#160;protected]</a></span></p>
						    	</div>
                ...
                <li class="user_setting">
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	<div class="user_set_header">
					    		<img class="float-left" src="images/team/e1.png" alt="e1.png">
						    	<p>Kim Hunter <br><span class="address"><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="62090b0f0a170c16071022050f030b0e4c010d0f">[email&#160;protected]</a></span></p>
					    	</div>
					    	<div class="user_setting_content">
								<a class="dropdown-item active" href="#">My Profile</a>
								<a class="dropdown-item" href="#">Messages</a>
				...
				<li><span>Pages</span>
					<ul>
						...
						<li><span>User Admin</span>
							<ul>
								<li><a href="page-dashboard.html">Dashboard</a></li>
								<li><a href="page-my-courses.php">Mes produits</a></li>
								<li><a href="page-my-order.html">My Order</a></li>
								<li><a href="page-my-message.html">My Message</a></li>
								<li><a href="page-my-review.html">My Review</a></li>
								<li><a href="page-my-bookmarks.html">My Bookmarks</a></li>
			...
			<div class="user_board">
				...
				<div class="dashbord_nav_list">
					<ul>
						...
						<li class="active"><a href="page-my-listing.html"><span class="flaticon-add-contact"></span> Add listing</a></li>
					</ul>
					<h4>Account</h4>
					<ul>
							...
							<div class="dashboard_navigationbar dn db-1199">
								<div class="dropdown">
									...
									<ul id="myDropdown" class="dropdown-content">
										<li><a href="page-dashboard.html"><span class="flaticon-puzzle-1"></span> Dashboard</a></li>
										<li><a href="page-my-courses.html"><span class="flaticon-online-learning"></span> My Courses</a></li>
										<li class="active"><a href="page-my-order.html"><span class="flaticon-shopping-bag-1"></span> Order</a></li>
										<li><a href="page-my-message.html"><span class="flaticon-speech-bubble"></span> Messages</a></li>
										<li><a href="page-my-review.html"><span class="flaticon-rating"></span> Reviews</a></li>
										<li><a href="page-my-bookmarks.html"><span class="flaticon-like"></span> Bookmarks</a></li>
...
?>
													...
													<form method="post" name="myform" action=modif.php>
															<div class="my_profile_setting_input form-group">
														    	<label for="formGroupExampleInput1">Id du produit</label>
														    	<input type="text" class="form-control" id="formGroupExampleInput1" name="idproduit" value="<?php echo $id?>">
															</div>
															<div class="my_profile_setting_input form-group">
														    	<label for="formGroupExampleInput2">nom du produit</label>
														    	<input type="text" class="form-control" id="formGroupExampleInput2" name="nom" value="<?php echo $nom?>">
															</div>
														</div>
														<div class="col-xl-6">
															<div class="my_profile_setting_input form-group">
														    	<label for="formGroupExampleInput3">Prix du produit</label>
														    	<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="5 dt" name="prix" value="<?php echo $prix?>">
															</div>
															<div class="my_profile_setting_input form-group">
														    	<label for="exampleInputPhone">Quantité du produit</label>
														    	<input type="text" class="form-control" id="exampleInputPhone" name="nbproduit" value="<?php echo $nb?>">
															</div>

															<div class="my_profile_setting_input form-group">
														    	<label for="exampleInputPhone">Description du produit</label>
														    	<input type="text" class="form-control" id="exampleInputPhone" name="description" value="<?php echo $description ?>">
															</div>
														</div>
														
														<div class="col-lg-12">
															
															<input type="file" name="image" value="upload" name="image" value="<?php echo $image ?>">
														</div>
...
alert("veuillez remplir le champ");
														...
														<input type="submit" name="modifier" value="modifier" onclick="test()">
...
<!-- Mirrored from grandetest.com/theme/edumy-html/page-my-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Nov 2019 14:50:54 GMT -->
</html>