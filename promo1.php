...
//mail("oussema.sboui@esprit.tn" ,"test" , "nouvelle promo saisie ", $header);
$to='wes.sboui@gmail.com';
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hadouej Sonia&nbsp; <img class="img-profile rounded-circle" src="sousou.jpg">
              </a>
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Ajout du Produit</h1>
          <!-- DataTales Example -->
...
<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><em class="fas fa-cogs"> Ajouter un nouveau Produit</em></h6>
  ...
  <td>
  <input width="10%" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="NomProduit" onBlur="VerifNom(this)" name="nomprod">
  </td></tr>

  <tr>
    <td><th>Référence du Produit&nbsp; </th></td>
  <td>
  <input width="10%" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="reference" name="referenceprod" required>
  </td></tr>
			<tr>
    <td><th>Catégorie du Produit&nbsp; &nbsp; </th>
  <td>
  <input width="10%" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="CategorieProduit" onBlur="VerifNom(this)" name="categorieprod">
  </td></tr>
 <tr>
    <td><th>Prix en dinars</th>
  <td>
  <input width="10%" type="number" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="100" onBlur="VerifNom(this)" name="prixprod">
  </td></tr>
<tr>
    <td><th>Etat du Produit&nbsp; &nbsp; </th>
 <th>
					  <select name="etatprod" width="10%">
...
<tr>
  ...
  <th> <br><br><br><td><em class="fas fa-plus-circle" onClick="verifForm(this)"></em><input type="submit" value="Valider l'ajout" name="mailform"  class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"onClick="verifForm(this)"  class=""> </th>
  </td></tr>
  </table>
</form>
        </div>
